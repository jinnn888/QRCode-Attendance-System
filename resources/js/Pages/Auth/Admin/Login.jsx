  ...
  return (<>
         <div className="flex justify-end">
            <Link href={route('login')} >
                <h2 className="text-pink-700 uppercase text-end p-4 hover:underline cursor-pointer">login as student</h2>
            </Link>
        </div>
        <div className="flex flex-row justify-around items-center h-[80vh] ">
            ...
            <div className="p-4 rounded border border-gray-200 shadow-sm w-[500px]">
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    <h2 className="text-gray-500 text-sm">Logging in as Beadle.</h2>
                    <label
                        htmlFor="Username"
